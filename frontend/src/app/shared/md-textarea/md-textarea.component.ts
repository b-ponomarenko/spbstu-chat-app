...
export const MD_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => MdTextareaComponent),
  multi: true
};

// Invalid textarea type. Using one of these will throw an MdInputUnsupportedTypeError.
...
export class MdInputUnsupportedTypeError extends MdError {
  constructor(type: string) {
    super(`Input type "${type}" isn't supported by md-textarea.`);
  }
}
...
export class MdTextareaComponent implements ControlValueAccessor, AfterContentInit, OnChanges {
  ...
  /**
   * Convert the value passed in to a value that is expected from the type of the md-textarea.
   * This is normally performed by the *_VALUE_ACCESSOR in forms, but since the type is bound
   * on our internal textarea it won't work locally.
   * @private
   */
...
@NgModule({
  declarations: [MdPlaceholder, MdTextareaComponent, MdHint],
  imports: [CommonModule, FormsModule],
  exports: [MdPlaceholder, MdTextareaComponent, MdHint],
})
